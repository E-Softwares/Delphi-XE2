...
Type
  TFormMDIMain = Class(TForm)
    ...
    Procedure TaskDialogZipDownloaderButtonClicked(
      Sender: TObject;
      ModalResult: TModalResult;
      Var CanClose: Boolean);
    Procedure TaskDialogZipDownloaderTimer(
      Sender: TObject;
      TickCount: Cardinal;
      Var Reset: Boolean);
...
Procedure TFormMDIMain.FormClose(
  Sender: TObject;
  Var Action: TCloseAction);
Begin
  SaveConfig;
...
Procedure TFormMDIMain.TaskDialogZipDownloaderButtonClicked(
  Sender: TObject;
  ModalResult: TModalResult;
  Var CanClose: Boolean);
Begin
